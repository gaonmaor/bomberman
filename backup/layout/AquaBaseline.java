...
class AquaBaseline
    ...
    private int getSliderBaseline(JSlider slider, int height) {
        if (slider.getPaintLabels()) {
            ...
            if (value != null) {
                ...
                int yPosition = Math.max(trackY, yPosition);
    ...
    private int getCheckBoxBaseline(AbstractButton button, int height) {
        ...
        SwingUtilities.layoutCompoundLabel(button, fm, "a", button.getIcon(), button.getVerticalAlignment(), button.getHorizontalAlignment(), button.getVerticalTextPosition(), button.getHorizontalTextPosition(), viewRect, iconRect, textRect, button.getText() == null ? 0 : button.getIconTextGap());
